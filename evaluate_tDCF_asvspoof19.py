'''
Original Author: You Zhang
Original URL: https://github.com/yzyouzhang/AIR-ASVspoof/blob/master/evaluate_tDCF_asvspoof19.py
Modified by CLAD 23 anonymous authors
'''
...
# Since eval_metrics modules changes in 2021, I copied the older version to here.
import sys
